...
- **Dashboard**: S&P 500 Herd Flow 배너, 현금 포함 포트폴리오 평가 요약, 자산 히스토리, 핵심 리밸런싱 체크, 보유 종목 HERD 행동 카드
...
신호 신뢰도는 데이터 품질과 별도로 계산합니다. 저장된 HERD 히스토리와 이후 가격 흐름을 비교해 Flee 적중률, Rush 적중률, MDD 개선, 수익률 보존, 연간 행동 수를 보여줍니다.
