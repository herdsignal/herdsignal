...
| 점수     | 단계                          | 색상      | 행동                      |
| -------- | ----------------------------- | --------- | ------------------------- |
| 0 – 15   | **Flee** — 군중이 도망침      | 🔵 파랑   | 적극 매수 (30% 추가)      |
| 15 – 40  | **Scatter** — 군중이 흩어짐   | 🩵 연파랑 | 분할 매수 시작 (10% 추가) |
| 40 – 60  | **Calm** — 움직임 없음        | ⚫ 회색   | 현재 비중 유지            |
| 60 – 75  | **Drift** — 서서히 몰림       | 🟠 주황   | 부분 익절 (5% 감소)       |
| 75 – 100 | **Rush** — 군중이 폭주        | 🔴 빨강   | 적극 익절 (30% 감소)      |
...
- **AI 리밸런싱** _(Phase 2)_ — Claude API 기반 포트폴리오 분석 + 종목별 구체적 금액 제안
...
v1 한계: 현재 지표는 전부 후행 지표다. Phase 2에서 선행 지표를 추가하면
신호 정확도가 높아질 것으로 예상한다.
