...
같은지는 원문을 확인해야 한다. 차단 44건은 자동 추정하지 않는다.
...
최신 v5 진단은 공식 구성 301건과 ticker 변경 16건을 재생했다. 차단
사건 44건, 오류 4건, 최종 구성 493개로 아직 진단 전용이다. 오류는
EVHC·DXC의 선행 편입 누락과 NLOK·PEAK의 선행 동일성 사건 누락으로 모두
설명되며, 재생 엔진이 임의로 고치지 않는다.
