...
ticker 변경 16건, 기업 구성 연속성 4건, 차단 사건 39건으로 구성된다.
...
2016-07-18 원본 480종목에 HCP를 진단 보정한 481종목으로 321개 검증 사건을
재생하면 구조 오류는 0건, 최종 구성은 494종목이다. 차단 39건은 다음
작업 대기열로 분리했다.

- P0 공식 구성 행동·적용 세션 의미 검토: 5건
- P1 SEC 기업행동·CIK·S&P 구성 연속성 검토: 22건
...
6. P1 22건의 CIK·ticker·합병 연속성 검증
