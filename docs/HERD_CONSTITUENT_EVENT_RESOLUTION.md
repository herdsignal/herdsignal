...
- 공식 구성 사건 해결: 294/397건
- 검증된 ticker 동일성 변경: 11건
- 미해결 후보 행: 81건
- 완전 일치: 공식 서술문 127건, 공식 표 96건
- 후보 날짜 교정: 공식 표 56건, 공식 서술문 12건
- 공식 문서 재탐색: 89건
- 문서 내 의미 추출: 8건
- 행동 충돌: 6건
- 동일성·날짜 충돌: 3건
...
현재 11건을 검증해 기존 REMOVE/ADD 22행을 `IDENTITY_CHANGE` 11행으로
대체했다. 동일 CIK만 확인되고 날짜가 없는 후보는 계속 보류한다.

최신 통합 원장은 386행이다. 공식 구성 사건 294건, ticker 변경 11건,
차단 사건 81건으로 구성된다. 2016-07-18 공개 기준 구성으로 수행한
진단 재생은 305개 검증 사건을 반영했으며 오류 6건, 최종 구성 494개다.
