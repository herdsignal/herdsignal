...
describe('Layout', () => {
  it('대시보드와 관찰만 주요 경로로 제공하고 연구는 보조 메뉴에 둔다', () => {
    render(
    ...
    expect(screen.queryByRole('link', { name: '연구' })).not.toBeInTheDocument()
    ...
    expect(screen.getByRole('link', { name: 'HERD 연구실' })).toHaveAttribute('href', '/herd-lab')
  })
