...
from herd.sec_guidance_v9_independent_validation import build


ROOT = Path(__file__).resolve().parents[2]


def test_v9_holdout_excludes_all_prior_review_accessions() -> None:
...
def test_v9_locked_sample_hash_and_gate() -> None:
    report_path = ROOT / "data/reports/sec_guidance_structure_v9.json"
    review_path = ROOT / "data/reports/sec_guidance_structure_v9_review.csv"
    candidate_path = ROOT / "data/reports/sec_guidance_structure_v9_candidates.csv"
