"""잠긴 V6 80건을 원문 판정하고 Wilson 정확도 게이트를 계산한다."""
...
CONFIG = Path(__file__).with_name("sec_guidance_structure_v6_review.json")
PROTOCOL = Path(__file__).with_name("sec_guidance_structure_parser_v6.json")
