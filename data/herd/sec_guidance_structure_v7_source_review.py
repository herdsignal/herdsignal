"""잠긴 V7 80건을 SEC 원문으로 판정하고 Wilson 정확도 게이트를 계산한다."""
...
CONFIG = Path(__file__).with_name("sec_guidance_structure_v7_review.json")
PROTOCOL = Path(__file__).with_name("sec_guidance_v7_independent_validation.json")
