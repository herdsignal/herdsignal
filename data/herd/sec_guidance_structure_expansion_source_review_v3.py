"""새 기업 80건 V3 구조 파서 원문 판정과 Wilson 게이트를 실행한다."""
...
CONFIG = Path(__file__).with_name("sec_guidance_structure_expansion_review_v3.json")
PROTOCOL = Path(__file__).with_name("sec_guidance_structure_parser_v3.json")
