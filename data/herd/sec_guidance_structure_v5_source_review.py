"""V4 accession을 제외한 잠긴 V5 표본을 원문 판정하고 정확도 게이트를 계산한다."""
...
CONFIG = Path(__file__).with_name("sec_guidance_structure_v5_review.json")
PROTOCOL = Path(__file__).with_name("sec_guidance_structure_parser_v5.json")
